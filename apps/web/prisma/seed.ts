...
const JOBS: JobSeed[] = [
  ...
  },
  {
    ...
    experienceLevel: 'SENIOR',
    experienceYears: 5,
    skillsRequired: ['Python', 'PostgreSQL', 'Airflow', 'dbt', 'Snowflake'],
    description:
      'Own the analytics data pipeline feeding the recruiter dashboards. Replace brittle cron jobs with Airflow + dbt + proper observability.',
    requirements: [
      '5+ years data engineering in production',
      'Strong SQL + Python',
      'Comfort owning a pipeline end-to-end',
    ].join('\n'),
    benefits: 'Remote-first, equity, $2k learning budget.',
    postedDaysAgo: 9,
  },
  {
    companySlug: 'hirepilot-demo',
    ...
    experienceLevel: 'SENIOR',
    experienceYears: 5,
    skillsRequired: ['React Native', 'TypeScript', 'iOS', 'Android', 'Expo'],
    description:
      'Lead the candidate-facing mobile app rewrite — push notifications, offline cache, biometrics. Ship to App Store / Play Store weekly.',
    requirements: [
      '5+ years React Native in production',
      'You have shipped at least one production app',
      'Comfort with native iOS / Android bridges',
    ].join('\n'),
    benefits: 'Remote, equity, $2k device stipend.',
    postedDaysAgo: 4,
  },
